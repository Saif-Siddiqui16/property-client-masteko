    ...
    return (
        <MainLayout title="Inspection Templates">
                        ...
                        {templates.map((temp) => (
                            <tr key={temp.id} className="hover:bg-gray-50/50 transition-colors group cursor-pointer">
                                ...
                                <td className="px-6 py-4">
                                    <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase border ${temp.type === 'Move-Out' ? 'bg-blue-50 text-blue-600 border-blue-100' : 'bg-indigo-50 text-indigo-600 border-indigo-100'}`}>
                                        {temp.type}
                                    </span>
                                </td>
            ...
            <div className="mt-8 flex items-center justify-between px-2">
                <span className="text-xs font-bold text-gray-400">Showing 1 to 6 of 6 templates</span>
